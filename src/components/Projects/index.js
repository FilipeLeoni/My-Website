...
function Projects() {
  return (
    <section className='project'>
        ...
        <Component name="My Website" description="I designed and implemented the site you are browsing right now!" link="https://github.com/FilipeLeoni/My-Website" img={Portfolio} github="https://github.com/FilipeLeoni/My-Website"/>
        ...
        <Component name="Cep Finder" description="Website with the functionality to find the address by the typed zip code."link="https://github.com/FilipeLeoni/Buscar-cep-ReactJS" img={Buscador} github="https://github.com/FilipeLeoni/Buscar-cep-ReactJS"/>
        </div>
    </section>
  )
}
